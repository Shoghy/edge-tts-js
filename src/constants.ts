export const BASE_URL = "api.msedgeservices.com/tts/cognitiveservices";
export const TRUSTED_CLIENT_TOKEN = "6A5AA1D4EAFF4E9FB37E23D68491D6F4";

export const WSS_URL = `wss://${BASE_URL}/websocket/v1?Ocp-Apim-Subscription-Key=${TRUSTED_CLIENT_TOKEN}`;
export const VOICE_LIST = `https://${BASE_URL}/voices/list?Ocp-Apim-Subscription-Key=${TRUSTED_CLIENT_TOKEN}`;

export const DEFAULT_VOICE = "en-US-EmmaMultilingualNeural";

export const CHROMIUM_FULL_VERSION = "140.0.3485.14";
